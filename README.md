...
### Usage
Once the server is running, or the heroku server has responded, you will find yourself in the landing page, where you can upload a .fasta or .csv file containing genomic sequences.
